...
const houses = [
  { num: "XII",  title: "The House of Foreign Lands",           sub: "Gateway to distant shores",            desc: "The primary house of foreign travel and settlement abroad. The 12th lord's sign, strength, and connections to other houses determine your entire relationship with foreign countries and life in distant lands." },
  { num: "IX",   title: "Long Journeys & Higher Connections",   sub: "The road of fortune and dharma",       desc: "Governs long-distance travel, foreign education, and divine fortune in foreign lands. A strong 9th house connection with the 12th is one of the clearest indicators of foreign settlement and spiritual travel." },
  { num: "VII",  title: "Foreign Business & Partnerships",      sub: "The bridge of international bonds",    desc: "Governs foreign business dealings, international partnerships, and living abroad due to a spouse or professional relationships. A strong 7th house opens doors through others in foreign lands." },
  { num: "III",  title: "Short Journeys & Travel Courage",      sub: "The forge of the wandering spirit",    desc: "Rules domestic travel, short journeys, and the inner courage required to take the very first step towards relocation. A strong 3rd house gives the boldness to leave and explore." },
  { num: "IV",   title: "Leaving the Homeland",                 sub: "The roots that must be released",      desc: "An afflicted or weakened 4th house combined with a strong 12th house is one of the clearest indicators that a person is destined to leave their homeland — by karma, not by accident." },
  { num: "VIII", title: "Sudden & Unexpected Foreign Journeys", sub: "The portal of transformative travel",  desc: "Governs unexpected travel, especially journeys for health, deep transformation, or sudden life changes abroad. 8th house foreign connections often bring the most life-altering overseas experiences." },
];

const planets = [
  { glyph: "☊", name: "Rahu",    sub: "The Karaka of Foreign Travel",           desc: "The most powerful indicator of foreign travel and settlement. Rahu in the 12th, 9th, or connected to the 12th lord almost always creates strong foreign potential. Rahu thrives in foreign lands." },
  { glyph: "☽", name: "Moon",    sub: "Restlessness & Longing for Distant Lands", desc: "Moon in the 12th house or connected to Rahu creates a deep inner restlessness and longing to live away from one's birthplace — the soul that always feels more at home elsewhere." },
  { glyph: "♄", name: "Saturn",  sub: "Foreign Labour & Long-term Settlement",  desc: "Saturn connected to the 12th house indicates hard work in foreign lands — but often culminates in permanent, stable settlement and long-term success after initial struggles." },
  { glyph: "♀", name: "Venus",   sub: "Travel for Love, Luxury & Creativity",   desc: "Venus with strong foreign house connections indicates travel for romance, artistic pursuits, or a life of beauty, comfort, and creative fulfilment in a foreign country." },
  { glyph: "☿", name: "Mercury", sub: "Foreign Business & Communication",        desc: "Mercury's connection with foreign houses indicates success in international trade, communication-based foreign work, and intellectual pursuits that cross borders and cultures." },
  { glyph: "☋", name: "Ketu",    sub: "Spiritual Travel & Past-Life Abroad",    desc: "Ketu in the 12th house creates a spiritual pull towards specific foreign countries — often places the soul has a past-life karmic connection with and must return to complete." },
];

const travelNumbers = [
  { num: "5", title: "The Natural Traveller",     ruler: "Mercury", color: "#d4f0d4", desc: "Ruled by Mercury. The most travel-oriented of all numbers. Number 5s rarely stay in one place for long and naturally thrive in international environments and cross-cultural settings." },
  { num: "7", title: "The Spiritual Wanderer",    ruler: "Ketu",    color: "#d4d4f0", desc: "Ruled by Ketu. Number 7s are drawn to foreign lands for spiritual growth, solitude, and deeper self-discovery. Their overseas journeys are rarely for money — always for meaning." },
  { num: "3", title: "The Global Ambassador",     ruler: "Jupiter", color: "#f0e4c8", desc: "Ruled by Jupiter. Number 3s often travel for education, teaching, and cultural exchange. They frequently settle in places of higher learning, philosophy, and spiritual significance." },
  { num: "4", title: "Foreign Opportunity Seeker", ruler: "Rahu",  color: "#c8d4f0", desc: "Ruled by Rahu. Travel often comes after struggle but leads to lasting foreign success. Number 4s find that foreign lands offer opportunities their homeland could never provide." },
  { num: "8", title: "The Long-haul Settler",     ruler: "Saturn",  color: "#c8c8d0", desc: "Ruled by Saturn. Like Number 4, foreign success comes through sustained effort and patience. Number 8s who settle abroad often build something slow, enduring, and deeply rooted." },
];

const problems = [
  "I have been applying for a visa repeatedly and getting rejected — why?",
  "When will I finally get to travel or settle abroad?",
  "I have an opportunity to work overseas — should I take it?",
  "Which country is most aligned with my chart for success and happiness?",
  "Will my family also be able to join me abroad eventually?",
  "I am studying abroad — will I find a job and settle there permanently?",
  "I am settled abroad but deeply unhappy — should I return to India?",
  "Can astrology identify the right direction or country for my relocation?",
  "My immigration case is pending for months — when will it resolve?",
  "Is foreign travel in my destiny at all, or am I meant to build my life here?",
];

const hiddenIssues = [
  "12th lord debilitated or placed in a dusthana — foreign travel blocked or heavily delayed despite strong desire",
  "Rahu afflicted or occupying the 6th or 8th house — visa rejections, immigration obstacles, and overseas complications",
  "Saturn heavily influencing the 12th house — long delays before foreign settlement, often fruiting only after age 36",
  "Ketu in the 4th house — deep karmic disconnection from homeland but directionless and unfocused foreign search",
  "4th lord exceptionally strong and well-placed — deep attachment to homeland quietly blocking relocation despite opportunities",
  "Moon-Rahu conjunction in the 12th — intense foreign longing but emotional unsettledness and restlessness once abroad",
];

const guideItems = [
  { n: "01", text: "Analyse the 12th, 9th, and 7th houses and their lords in full detail for foreign travel and settlement potential" },
  { n: "02", text: "Assess Rahu's precise placement, aspects, and Dasha timing to identify your foreign travel windows" },
  { n: "03", text: "Identify the best countries based on directional astrology, Rahu's position, and your 9th house lord's sign" },
  { n: "04", text: "Map the most auspicious Dasha and transit periods for visa applications, departure, and immigration filings" },
  { n: "05", text: "Recommend specific Rahu mantras, Ketu rituals, and remedies to ease foreign journey obstacles" },
...
/* ════════════════════════════════════════════════════════════════ */
/* PLANET ORBITAL CONFIG — 2 rings, 3 inner + 3 outer */
const INNER_R = 160;
const OUTER_R = 280;
const SYS_DIM = 700;
...
const PLANET_CFG = [
  { orbitR: INNER_R, angleDeg: 270, ballSize: 55, duration: 60,  dir: "cw"  }, // Rahu
  { orbitR: INNER_R, angleDeg: 30,  ballSize: 55, duration: 72,  dir: "cw"  }, // Moon
  { orbitR: INNER_R, angleDeg: 150, ballSize: 55, duration: 65,  dir: "cw"  }, // Saturn
  { orbitR: OUTER_R, angleDeg: 60,  ballSize: 65, duration: 95,  dir: "ccw" }, // Venus
  { orbitR: OUTER_R, angleDeg: 180, ballSize: 65, duration: 88,  dir: "ccw" }, // Mercury
  { orbitR: OUTER_R, angleDeg: 300, ballSize: 65, duration: 115, dir: "ccw" }, // Ketu
];
...
function Hero() {
  ...
  return (
    <section style={{ position: "relative", minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", overflow: "hidden", background: "white" }}>
      <div ref={bgRef} style={{ position: "absolute", inset: "-15%", backgroundImage: 'url("https://images.unsplash.com/photo-1436491865332-7a61a109cc05?w=1400&auto=format")', backgroundSize: "cover", backgroundPosition: "center", opacity: 0.18, willChange: "transform", pointerEvents: "none" }} />
      <div style={{ position: "relative", zIndex: 2, textAlign: "center", padding: "120px 40px 140px", animation: "hero-rise 1s cubic-bezier(.22,1,.36,1) forwards" }}>
        ...
        <div style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: 18, margin: "0 auto 32px", maxWidth: 700 }}>
          ...
          <span style={{ fontFamily: HEADING_FONT, fontStyle: "italic", fontSize: 22, color: MUTED, whiteSpace: "nowrap" }}>
            ✦ &nbsp; Is the world calling you? Your chart already knows if you will answer. &nbsp; ✦
          </span>
      ...
      <div style={{ maxWidth: 860, margin: "0 auto", padding: "100px 48px 80px", textAlign: "center", position: "relative", zIndex: 1 }}>
        ...
        <div className="r d1" style={{ borderLeft: `2px solid ${GOLD}`, paddingLeft: 28, marginBottom: 40, textAlign: "left", maxWidth: 680, margin: "0 auto 40px" }}>
          <p style={{ fontFamily: HEADING_FONT, fontStyle: "italic", fontSize: 22, color: DARK, lineHeight: 1.7, margin: 0, opacity: 0.8 }}>
            "In Vedic astrology, the possibility, timing, and nature of foreign journeys are clearly mapped in your birth chart. Whether you dream of settling abroad or building a global career — the stars have a definitive answer."
          </p>
        </div>

        <p className="r d2" style={{ fontFamily: BODY_FONT, fontSize: BODY_SIZE, color: MUTED, lineHeight: 2.1, marginBottom: 24 }}>
          Foreign travel — whether for work, education, settlement, or personal growth — is one of the most transformative life events. Some people have strong foreign destiny written in their chart; others have the desire but not the planetary support. Understanding which category you belong to changes everything about how you plan your future.
        </p>
        <p className="r d3" style={{ fontFamily: BODY_FONT, fontSize: BODY_SIZE, color: MUTED, lineHeight: 2.1, marginBottom: 52 }}>
          At Vedic Saar, we decode the 12th, 9th, and 7th houses, assess Rahu's placement and timing, and combine this with your numerological travel blueprint to give you precise, actionable foreign travel guidance.
        </p>

        <div className="r d4" style={{ display: "flex", gap: 2, justifyContent: "center", flexWrap: "wrap" }}>
          {["6 Foreign Travel Houses", "6 Planetary Travel Indicators", "Dasha Travel Timing"].map((s, i) => (
            ...
            <div key={i} className={`r d${(i % 3) + 1} hcard`}>
              ...
              <div style={{ padding: "38px 30px 34px" }}>
                <div style={{ display: "flex", alignItems: "center", justifyContent: "center", marginBottom: 26, height: 88 }}>
                  <img
                    src={`/assets/travellogos/${houseLogos[i]}`}
                    alt={h.title}
    ...
    <section ref={ref} style={{ background: CREAM2, position: "relative", overflow: "hidden" }}>
      ...
      <div style={{ maxWidth: 1300, margin: "0 auto", padding: "100px 48px 120px", position: "relative", zIndex: 1 }}>
        ...
        <p className="r d2" style={{ fontFamily: BODY_FONT, fontSize: 10, color: MUTED, textAlign: "center", letterSpacing: "0.22em", textTransform: "uppercase", margin: "0 0 56px" }}>
          Hover each planet to reveal its travel domain
        </p>
        ...
        <div style={{ width: "100%", display: "flex", justifyContent: "center", overflow: "hidden" }}>
          ...
          >
            ...
            <div style={{
              ...
              <span style={{ fontFamily: BODY_FONT, fontSize: 9, letterSpacing: "0.22em", color: "#3a2a06", textTransform: "uppercase", fontWeight: 600 }}>Travel</span>
            </div>
      ...
      <div style={{ maxWidth: 1160, margin: "0 auto", padding: "100px 72px 0", position: "relative", zIndex: 1 }}>
        <div style={{ textAlign: "center", marginBottom: 64 }}>
          ...
          <h2 className="r" style={{ fontFamily: HEADING_FONT, fontWeight: 400, fontSize: HEADING_SIZE, color: CREAM, lineHeight: 1.05, marginBottom: 14 }}>
            Numbers &amp; <em style={{ color: GOLD, fontStyle: "italic" }}>Foreign Travel</em>
          </h2>
          <p className="r d1" style={{ fontFamily: BODY_FONT, fontSize: BODY_SIZE, color: "rgba(245,240,232,0.42)", maxWidth: 500, margin: "0 auto", lineHeight: 1.9 }}>
            Certain numbers carry strong foreign destiny vibrations. Your total birth date number and name number reveal whether foreign sojourn is written in your cosmic code.
          </p>
        </div>
      </div>
        ...
        <div className="mobile-col-1" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 72 }}>
          <div className="r d1">
            <div style={{ display: "flex", alignItems: "center", gap: 14, marginBottom: 28 }}>
              ...
              <h3 style={{ fontFamily: HEADING_FONT, fontSize: 26, fontWeight: 500, color: DARK, margin: 0, lineHeight: 1.2 }}>
                Foreign Travel Questions We Address
              </h3>
            </div>
            {problems.map((p, i) => (
          ...
          <div className="r d2">
            ...
            <p style={{ fontFamily: BODY_FONT, fontSize: BODY_SIZE, color: MUTED, marginBottom: 28, lineHeight: 1.9 }}>
              Certain planetary combinations create invisible barriers to foreign travel and settlement. Our reading specifically checks for:
            </p>
            ...
            <div style={{ marginTop: 36, padding: "24px 28px", background: DARK, borderLeft: `3px solid ${GOLD}` }}>
              <div style={{ fontFamily: HEADING_FONT, fontStyle: "italic", fontSize: 16, color: CREAM, lineHeight: 1.75, opacity: 0.82 }}>
                "If foreign lands are calling you, your chart already heard the call. Let us confirm it."
              </div>
            </div>
          </div>
        </div>
    ...
    <section ref={ref} style={{ backgroundImage: 'url("/assets/Testimonialsbg.png")', marginTop: -120, backgroundSize: "cover", backgroundPosition: "top center", padding: "130px 48px 150px", textAlign: "center", position: "relative", overflow: "hidden" }}>
      ...
      <div style={{ position: "relative", zIndex: 2, marginTop: 500 }}>
        ...
        <h2 className="r d1" style={{ fontFamily: HEADING_FONT, fontWeight: 400, fontSize: HEADING_SIZE, color: "black", margin: 0, lineHeight: 0.92, letterSpacing: "-0.02em" }}>
          Book Your<br />
          <span className="gold-shimmer">Foreign Travel</span><br />
          Consultation
        </h2>
...
/* ════════════════════════════════════════════════════════════════ */
export default function ForeignTravelPage() {
  return (
    <>
      <style>{CSS}</style>
      <Hero />
